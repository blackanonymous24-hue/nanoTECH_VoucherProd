...
<div style="margin:-10px;text-align:right;font-weight:bold;font-size:10px;padding-left:18px;color:<?php echo $color ?>"> <small style="font-size:10px;margin-left:-65px;position:absolute;"><?php echo $getprice;?> FCFA</small>
</div>	
</td>		
</tr>
</tbody>
