...
if(substr($timelimit,-1) == "d" & strlen($timelimit) >3){
  ...
  $timelimit = "Durasi:".substr($timelimit,0,-1)." Jour(s)";
}else if(substr($timelimit,-1) == "h"){
  $timelimit = "Durasi:".substr($timelimit,0,-1)."Heure(s)";
}else if(substr($timelimit,-1) == "w"){
  $timelimit = "Durasi:".(substr($timelimit,0,-1)*7)." Semaine(s)";
}	            	            
if($getprice == "0"){ $color = "#E50877";} 
...
elseif($getprice == "170000"){ $color = "#DC143C";} 
 ...
 <!--mks-mulai-->
<table style="display: inline-block;border-collapse: collapse;border: 1px solid #666;margin: 2.5px;width: 215px;overflow:hidden;position:relative;padding: 1px;margin: 0px;border: 1px solid #444; background:; ">
<tbody>
<tr>
...
<div style="margin:-10px;text-align:right;font-weight:bold;font-size:15px;padding-left:17px;color:<?php echo $color ?>"> <small style="font-size:11px;margin-left:-65px;position:absolute;"><?php echo $getprice;?> FCFA</small>
</div>	
</td>		
</tr>
</tbody>
...
<div style="padding:0px;border-bottom:1px solid;text-align:center;font-weight:bold;font-size:17px;color:<?php echo $color ?>"><?php echo $username;?></div>
...
<b>TEL : 07 79 84 43 56 | 07 49 60 20 86</b>
<span id="num"><?= " [$num]"; ?>
</div>
</td>	
</tr>
