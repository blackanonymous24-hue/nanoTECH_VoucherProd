...
elseif($getprice == "2500"){ $color = "#F70000";}
...
<div style="margin:-10px;text-align:right;font-weight:bold;font-size:15px;padding-left:17px;color:<?php echo $color ?>"> <small style="font-size:11px;margin-left:-65px;position:absolute;"><?php echo $getprice;?> <?= $currency; ?></small>
</div>	
</td>		
</tr>
</tbody>
