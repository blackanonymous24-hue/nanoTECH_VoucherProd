...
sql = (
    "TRUNCATE TABLE mikrotik_script_sales_month_sync, mikrotik_script_sales RESTART IDENTITY;"
)
cmd = (
    "bash -lc 'cd /var/www/vouchernet && "
    f"sudo -u postgres psql -d vouchernet -c \"{sql}\" && "
    "systemctl restart vouchernet && sleep 2 && systemctl is-active vouchernet'"
)
